...
<c:choose>
  <c:when test="${term=='oil-tanned'}">
    A method of leather tanning in which oils or fats are used to cure the leather. Such leather is usually very supple and has a matte or "oily" finish and is not generally polishable.
  </c:when>
  ...
  <c:when test="${term=='cordura'}">
    A certified fabric from INVISTA used in a wide range of products from luggage and backpacks to boots, to military wear and performance apparel. Cordura&reg; is resistant to abrasions, tears and scuffs.
  </c:when>
