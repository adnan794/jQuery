...
<c:choose>
  <c:when test="${param.style=='7141832'}">
    ...
    <c:set target="${item}" property="features"
           value="<abbr>Oil-tanned</abbr> or polishable <abbr>full-grain</abbr> leather uppers. <abbr>Vibram</abbr> sole. <abbr>Goodyear welt</abbr>. Padded insole. Steel safety toe."/>
  </c:when>
  <c:when test="${param.style=='7173656'}">
    ...
    <c:set target="${item}" property="features"
           value="<abbr>Oil-tanned</abbr> <abbr>full-grain</abbr> leather uppers. <abbr>Vibram</abbr> sole. <abbr>Goodyear welt</abbr>. Padded insole. Steel safety toe. Texon&reg; insole."/>
  </c:when>
  <c:when test="${param.style=='7141922'}">
    ...
    <c:set target="${item}" property="price" value="$187.00"/>
    <c:set target="${item}" property="features"
           value="<abbr>Full-grain</abbr> leather uppers. Leather lining. <abbr>Vibram</abbr> sole. <abbr>Goodyear welt</abbr>."/>
  </c:when>
  <c:when test="${param.style=='7177382'}">
    ...
    <c:set target="${item}" property="features"
           value="<abbr>Full-grain</abbr> <abbr>oil-tanned</abbr> leather. Nylon mesh lining. Ortholite sock liner. EVA midsole. T84V Rubberlon outsole."/>
  </c:when>
  <c:when test="${param.style=='7141730'}">
    ...
    <c:set target="${item}" property="features"
           value="Alkali-resistant <abbr>full-grain</abbr> leather. <abbr>Cambrelle</abbr> nylon lining. Fiberglass shank. <abbr>Vibram</abbr> 4014 Cristy sole. <abbr>Stitch-down</abbr> construction."/>
  </c:when>
  <c:when test="${param.style=='7141833'}">
    ...
    <c:set target="${item}" property="features"
           value="<abbr>Full-grain</abbr> leather foot. 1000 Denier <abbr>Cordura</abbr> Viper cloth shaft. <abbr>Goodyear welt</abbr>. Leather Lining. Body Cushion Insole. <abbr>Vibram</abbr> Robinson Outsole."/>
  </c:when>
  <c:when test="${param.style=='7257914'}">
    ...
    <c:set target="${item}" property="features"
           value="<abbr>Full-grain</abbr> leather foot. 1000 Denier <abbr>Cordura</abbr> Viper cloth shaft. <abbr>Gore-Tex</abbr> lining. Stich-down construction."/>
  </c:when>
  <c:when test="${param.style=='7269643'}">
    ...
    <c:set target="${item}" property="features"
           value="<abbr>Full-grain</abbr> leather. <abbr>Cambrelle</abbr>&reg; lining. Steel safety toe. Electrical hazard protection. Poliyou&reg; cushion insole. Rubber lug outsole."/>
  </c:when>
  <c:when test="${param.style=='7332058'}">
    <c:set target="${item}" property="name" value="Chippewa 9-inch Briar Waterproof Bison Boot"/>
    <c:set target="${item}" property="sku" value="7332058"/>
    <c:set target="${item}" property="height" value="9 inches"/>
    <c:set target="${item}" property="lining" value="Chip-A-Tex&reg; waterproof"/>
    <c:set target="${item}" property="colors" value="tan/brown/amber"/>
    <c:set target="${item}" property="price" value="$138.00"/>
    <c:set target="${item}" property="features" value="Amber shark skin tip leather. Chip-A-Tex&reg; waterproof bootie. <abbr>Vibram</abbr> long haul outsole. Steel shank. Black nickle non-tarnishable hardware. Heavy duty stay-tied laces. Removable cushion orthotic. Non-insulated. "/>
  </c:when>
  <c:otherwise>
    <c:set target="${item}" property="name" value="&mdash;-"/>
    <c:set target="${item}" property="sku" value="&mdash;-"/>
    <c:set target="${item}" property="height" value="&mdash;-"/>
    <c:set target="${item}" property="lining" value="&mdash;-"/>
    <c:set target="${item}" property="colors" value="&mdash;-"/>
    <c:set target="${item}" property="price" value="&mdash;-"/>
    <c:set target="${item}" property="features" value="&mdash;-"/>
  </c:otherwise>
</c:choose>
<div>
